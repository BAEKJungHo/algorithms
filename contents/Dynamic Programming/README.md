...
- __풀이 방법__
  ...
  - `개인적인 생각`
    - 책 몇 문제를 풀어봤는데, 구현해야하는 코드의 양은 적은데, 점화식을 생각하는게 생각보다 어려웠다. 책의 문제를 분석해본결과 보통 1, 2 길면 3까지는 초기값으로 쓰는것 같고, 점화식을 구하기 위해서 그냥 3이상의 숫자를 하나 선정해서 구하는 것같다. 점화식을 구하려고 너무 큰 숫자를 선정하거나 너무 깊게 생각하다보면 문제를 못풀 것 같다.
